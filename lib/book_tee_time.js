...
_get_tee_time_page = async function (whatDate, data) {
  ...
  if (response.statusCode === 200 && response.body.indexOf('"tee_time":{') > 0) {
    //.log(`tee-time page found for ${whatDate}`)
...
_book_the_tee_time_recursive = async function (
  ...
  console.log(
    `_book_the_tee_time_recursive whatDate: ${whatDate} time: ${time} dateComesAlive: ${dateComesAlive} player1UID: ${player1UID} player2UID: ${player2UID} player3UID: ${player3UID} player4UID: ${player4UID}`
  )
...
exports.book_the_tee_time_recursive = async function (
  ...
  console.log(
    `*** player1UID: ${player1UID} player2UID: ${player2UID} player3UID: ${player3UID} player4UID: ${player4UID}`
  )

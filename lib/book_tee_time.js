...
_get_tee_time_page = async function (whatDate, data) {
  ...
  console.log(`_get_tee_time_page options: ${JSON.stringify(options)}`)
  // Get the Page
  const response = await requestPromise(options)
  const json = JSON.parse(response.body)
  //console.log(`*** _get_tee_time_page response: ${JSON.stringify(response)}`)
  //console.log(`\n\nresponse done....\n\n`)
...
_book_the_tee_time_recursive = async function (
  ...
  console.log(`_get_tee_time response: ${JSON.stringify(response)}`)
